...
public class Understanding_Constructors {
	...
	// It is a block. It is similar to a method. But it is not a method. It has the
	// name of the Class
	...
	// 1. Default Constructor (No argument) - Compiler generates this constructor
	...
	// Misconception - Constructor is used to create an Object (This is totally
	// wrong
	// The ways to create an object are - new keyword, clone(), newInstance(),
	// de-serialization, factory methods
